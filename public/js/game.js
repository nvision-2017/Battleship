  ...
  function setGameOver(isWinner) {
    ...
    if(isWinner) {
      $('#turn-status').removeClass('alert-opponent-turn').removeClass('alert-your-turn')
              .addClass('alert-winner').html('You won! <a href="/war!" class="btn-leave-game">Play again</a> or <a href="/replay/'+gameid+'">Watch replay</a> of this game');
    } else {
      $('#turn-status').removeClass('alert-opponent-turn').removeClass('alert-your-turn')
              .addClass('alert-loser').html('You lost. <a href="/war!" class="btn-leave-game">Play again</a> or <a href="/replay/'+gameid+'">Watch replay</a> of this game');
    }
